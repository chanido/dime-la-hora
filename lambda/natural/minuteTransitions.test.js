...
test('transicion 29 -> 30 -> 31', () => {
    assert.equal(formatSpanishTime(12, 29), 'Casi las doce y media.');
...
test('transicion 44 -> 45 -> 46', () => {
    assert.equal(formatSpanishTime(17, 44), 'Casi las seis menos cuarto.');
...
test('transicion 02 -> 03 -> 04', () => {
    ...
    assert.equal(formatSpanishTime(21, 4), 'Casi las nueve y cinco.');
});
...
test('transicion 57 -> 58 -> 59', () => {
    ...
    assert.equal(formatSpanishTime(23, 59), 'Casi las doce.');
});